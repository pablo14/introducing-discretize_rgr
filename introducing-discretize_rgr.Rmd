...
Plotting
```{r, fig.cap="Left: accuracy, right: representativeness (sample size)"}
...
Want to learn more? `r emo::ji('green_book')` [Data Science Live Book](http://livebook.datascienceheroes.com/)
